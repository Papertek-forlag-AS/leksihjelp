...
- [ ] **FF-02**: False-friend data lives in Papertek API as `falseFriends` field on NB entries, seeded with ~50 pairs across NB→EN/DE/ES/FR
...
- [ ] **POLY-02**: Sense data lives in Papertek API as structured `senses` field with trigger context and example sentences
